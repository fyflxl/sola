...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ISA_Controller is
  ...
  signal isa_ctl_cnt_reg : STD_LOGIC_VECTOR ( 0 to 0 );
...
dir_isa_sd1_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\isa_ctl_cnt[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000AAA9AAA8"
    )
        port map (
      I0 => isa_ctl_cnt_reg(0),
      I1 => \^out\(0),
      I2 => isa_wr_done,
      I3 => isa_rd_done,
      I4 => s00_axi_aresetn,
...
\isa_ctl_cnt_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk_16m_i,
      CE => '1',
...
isa_ior_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"73"
    )
        port map (
...
isa_rd_done_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D0"
    )
        port map (
...
\isa_sa[15]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\isa_sd_out[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[10]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[11]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[12]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[13]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[14]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[15]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\isa_sd_out[15]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[8]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\isa_sd_out[9]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
isa_wr_done_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"4"
    )
        port map (
...
oe_isa_sd1_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
ISA_Controller_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ISA_Controller
     port map (
      ...
      s00_axi_aresetn_0 => isa_20190731_v1_0_S00_AXI_inst_n_1,
      \slv_reg1_reg[0]\ => isa_20190731_v1_0_S00_AXI_inst_n_9,
      \slv_reg1_reg[0]_0\ => isa_20190731_v1_0_S00_AXI_inst_n_8,
...
isa_20190731_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_isa_20190731_v1_0_S00_AXI
     port map (
      ...
      \current_state_reg[0]\ => isa_20190731_v1_0_S00_AXI_inst_n_8,
      \current_state_reg[0]_0\ => isa_20190731_v1_0_S00_AXI_inst_n_9,
      \current_state_reg[1]\ => isa_20190731_v1_0_S00_AXI_inst_n_10,
