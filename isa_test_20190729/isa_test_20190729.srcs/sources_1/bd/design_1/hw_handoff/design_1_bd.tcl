...
proc create_root_design { parentCell } {
  ...
  set isa_sd [ create_bd_port -dir IO -from 15 -to 0 isa_sd ]
  ...
  set sbhe [ create_bd_port -dir I sbhe ]
  ...
  connect_bd_net -net Net [get_bd_ports isa_sd] [get_bd_pins axi_isa_0/isa_sd]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets axi_isa_0_dir_isa_sd1]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets axi_isa_0_oe_isa_sd1]
  connect_bd_net -net axi_isa_0_oe_isa_sd2 [get_bd_ports oe_isa_sd2] [get_bd_pins axi_isa_0/oe_isa_sd2]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_isa_0/clk_16m_i] [get_bd_pins clk_wiz_0/clk_out1]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_isa_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net sbhe_0_1 [get_bd_ports sbhe] [get_bd_pins axi_isa_0/sbhe]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets sbhe_0_1]
