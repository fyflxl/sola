 ...
 *
 * @param   BaseAddress is the base address of the AXILITE_TESTdevice.
 ...
 * @note
 * C-style signature:
 * 	void AXILITE_TEST_mWriteReg(u32 BaseAddress, unsigned RegOffset, u32 Data)
 *
 */
 ...
 * @note
 * C-style signature:
 * 	u32 AXILITE_TEST_mReadReg(u32 BaseAddress, unsigned RegOffset)
 *
 */
