...
set ::env(PATH) "$::env(PATH);L:/Xilinx_201802/Vivado/2018.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);L:/Xilinx_201802/Vivado/2018.2/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);L:/Xilinx_201802/Vivado/2018.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);L:/Xilinx_201802/Vivado/2018.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);L:/Xilinx_201802/Vivado/2018.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sobel_filter.autotvin.dat"
	set constFileTvOut       "sobel_filter.autotvout.dat"
	set constFileHdlTvIn     "sobel_filter.autohdltvin.dat"
	set constFileHdlTvOut    "sobel_filter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
