...
if {[file isfile sobel_filter.autotvin.dat]} {
	file delete -force sobel_filter.autotvin.dat
}

if {[file isfile sobel_filter.autotvout.dat]} {
	file delete -force sobel_filter.autotvout.dat
}
