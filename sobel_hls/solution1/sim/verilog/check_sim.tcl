...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sobel_filter.autotvin_inter_pix_V_V.dat"
         "c.sobel_filter.autotvin_out_pix_V_V.dat"
         "c.sobel_filter.autotvin_rows.dat"
         "c.sobel_filter.autotvin_cols.dat"
         "c.sobel_filter.autotvout_out_pix_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sobel_filter.autotvout_out_pix_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
